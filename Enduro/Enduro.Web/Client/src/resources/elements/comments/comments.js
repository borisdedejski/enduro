...
var Comments = /** @class */ (function () {
    function Comments(api, eventAggregator) {
        this.api = api;
    ...
    Comments.prototype.attached = function () {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
    ...
    Comments.prototype.addComment = function () {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.api.post("/cars/" + this.carid + "/comments", {
                            message: this.comment,
                            // userId: "bc267bfd-09ce-4dfa-95b2-c01be7b56a02"
                            userId: this.userId
                        }).then(function () {
                            $(_this.commentsection).val("");
    ...
    Comments.prototype.removeComment = function (comment) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.api.post("/cars/comments/" + comment, {
                            userId: this.userId,
                            carId: this.carid
                        }).then(function () {
                            _this.eventAggregator.publish(new RefreshEvent);
    ...
    ], Comments.prototype, "carid", void 0);
    __decorate([
        bindable,
        __metadata("design:type", Object)
    ], Comments.prototype, "listofcomments", void 0);
    __decorate([
        bindable,
        __metadata("design:type", Object)

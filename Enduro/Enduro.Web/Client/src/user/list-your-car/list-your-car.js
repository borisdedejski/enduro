...
var ListYourCar = /** @class */ (function () {
    function ListYourCar(router, eventAggregator, api) {
        this.router = router;
        this.eventAggregator = eventAggregator;
        this.api = api;
        this.carLocationCountry = [
            { id: 0, name: 'Macedonia' },
            { id: 1, name: 'Serbia' }
        ];
    ...
    ListYourCar.prototype.attached = function () {
    ...
    //   });
    // }
    ListYourCar.prototype.navigateToStep2 = function () {
        var _this = this;
        this.router.navigate('listyourcar-2').then(function () {
...
export { ListYourCar };
//# sourceMappingURL=list-your-car.js.map
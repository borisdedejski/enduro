...
var Register = /** @class */ (function () {
    function Register(router, api, validator) {
        this.router = router;
        this.api = api;
    ...
    Register.prototype.signUpPost = function () {
        return __awaiter(this, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.api.post("/registration", this.user)];
                    case 1:
                        response = _a.sent();
                        return [4 /*yield*/, this.showSuccessMessage()];
                    case 2:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    Register.prototype.generateValidationRules = function () {
    ...
    Register.prototype.showSuccessMessage = function () {
    ...
    Register = __decorate([
        autoinject,
        __metadata("design:paramtypes", [Router, ApiService, ValidationController])
    ], Register);
    return Register;
}());
export { Register };

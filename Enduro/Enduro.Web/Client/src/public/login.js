...
var Login = /** @class */ (function () {
    function Login(router, eventAggregator, api) {
        this.router = router;
        this.eventAggregator = eventAggregator;
        this.api = api;
        this.subs = this.eventAggregator.subscribe(EventTest, function () {
        });
    }
    Login.prototype.activate = function () {
    };
    Login.prototype.deactivate = function () {
        this.subs.dispose();
    };
    ...
    Login.prototype.signInUser = function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.api.authenticate(this.user)];
                    case 1:
                        response = _a.sent();
